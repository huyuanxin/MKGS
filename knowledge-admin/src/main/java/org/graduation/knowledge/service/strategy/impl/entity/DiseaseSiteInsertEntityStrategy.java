 ...
 * @author huyuanxin
 */
@Service("DiseaseSiteInsertEntityStrategy")
public class DiseaseSiteInsertEntityStrategy implements InsertEntityStrategy {
    ...
    @Autowired
    public DiseaseSiteInsertEntityStrategy(Disease3dMapper disease3dMapper, DiseaseSite3dMapper diseaseSite3dMapper, Symptom3dMapper symptom3dMapper) {
