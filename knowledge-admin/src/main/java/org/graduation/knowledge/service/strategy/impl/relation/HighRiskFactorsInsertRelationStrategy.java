...
public class HighRiskFactorsInsertRelationStrategy implements InsertRelationStrategy {
    ...
    @Autowired
    public HighRiskFactorsInsertRelationStrategy(DiseaseRelation3dMapper diseaseRelation3dMapper) {
    ...
    public Boolean insertRelation(String headName, String tailName, String headType, String tailType) {
        if (DISEASE.equals(headType) && HIGH_RISK_FACTORS.equals(tailType)) {
