 ...
 * @author huyuanxin
 */
@Service("relatedDiseaseInsertRelationStrategy")
public class RelatedDiseaseInsertRelationStrategy implements InsertRelationStrategy {
    ...
    @Autowired
    public RelatedDiseaseInsertRelationStrategy(DiseaseRelation3dMapper diseaseRelation3dMapper, TreatmentRelation3dMapper treatmentRelation3dMapper, SymptomRelation3dMapper symptomRelation3dMapper) {
