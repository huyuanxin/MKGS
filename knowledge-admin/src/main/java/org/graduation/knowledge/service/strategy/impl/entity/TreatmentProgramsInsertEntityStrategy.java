 ...
 * @author huyuanxin
 */
@Service("TreatmentProgramsInsertEntityStrategy")
public class TreatmentProgramsInsertEntityStrategy implements InsertEntityStrategy {
