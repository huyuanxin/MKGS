 ...
 * @author huyuanxin
 */
@Service("CheckInsertEntityStrategy")
public class CheckInsertEntityStrategy implements InsertEntityStrategy {
    ...
    @Autowired
    public CheckInsertEntityStrategy(AuxiliaryExamination3dMapper auxiliaryExamination3dMapper, CheckSubject3dMapper checkSubject3dMapper, Check3dMapper check3dMapper) {
