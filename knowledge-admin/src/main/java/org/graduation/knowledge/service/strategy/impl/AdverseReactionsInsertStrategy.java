 ...
 * @author huyuanxin
 */
@Service("AdverseReactionsInsertStrategy")
public class AdverseReactionsInsertStrategy implements InsertStrategy {
    ...
    @Autowired
    public AdverseReactionsInsertStrategy(Disease3dMapper disease3dMapper, Symptom3dMapper symptom3dMapper, AdverseReactions3dMapper adverseReactions3dMapper) {
