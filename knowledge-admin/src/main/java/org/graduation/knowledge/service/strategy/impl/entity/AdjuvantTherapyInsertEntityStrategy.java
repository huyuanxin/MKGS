 ...
 * @author huyuanxin
 */
@Service("AdjuvantTherapyInsertEntityStrategy")
public class AdjuvantTherapyInsertEntityStrategy implements InsertEntityStrategy {

    final private AdjuvantTherapy3dMapper adjuvantTherapy3dMapper;
    final private Treatment3dMapper treatment3dMapper;

    @Autowired
    public AdjuvantTherapyInsertEntityStrategy(AdjuvantTherapy3dMapper adjuvantTherapy3dMapper, Treatment3dMapper treatment3dMapper) {
