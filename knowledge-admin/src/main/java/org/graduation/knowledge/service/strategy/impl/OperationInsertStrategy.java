 ...
 * @author huyuanxin
 */
@Service("OperationInsertStrategy")
public class OperationInsertStrategy implements InsertStrategy {

    final private Treatment3dMapper treatment3dMapper;
    final private Operation3dMapper operation3dMapper;

    @Autowired
    public OperationInsertStrategy(Treatment3dMapper treatment3dMapper, Operation3dMapper operation3dMapper) {
