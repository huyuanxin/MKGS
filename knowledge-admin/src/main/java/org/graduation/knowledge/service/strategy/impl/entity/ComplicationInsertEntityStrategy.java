 ...
 * @author huyuanxin
 */
@Service("ComplicationInsertEntityStrategy")
public class ComplicationInsertEntityStrategy implements InsertEntityStrategy {
    ...
    @Autowired
    public ComplicationInsertEntityStrategy(Symptom3dMapper symptom3dMapper, Disease3dMapper disease3dMapper, Complication3dMapper complication3dMapper) {
