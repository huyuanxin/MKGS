 ...
 * @author huyuanxin
 */
@Service("SymptomAndSignInsertStrategy")
public class SymptomAndSignInsertStrategy implements InsertStrategy {
    ...
    @Autowired
    public SymptomAndSignInsertStrategy(Disease3dMapper disease3dMapper, Symptom3dMapper symptom3dMapper, SymptomAndSign3dMapper symptomAndSign3dMapper) {
