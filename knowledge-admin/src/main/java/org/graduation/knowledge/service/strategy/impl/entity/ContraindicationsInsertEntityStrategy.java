 ...
 * @author huyuanxin
 */
@Service("ContraindicationsInsertEntityStrategy")
public class ContraindicationsInsertEntityStrategy implements InsertEntityStrategy {
    ...
    @Autowired
    public ContraindicationsInsertEntityStrategy(Symptom3dMapper symptom3dMapper, Disease3dMapper disease3dMapper, Complication3dMapper complication3dMapper, Contraindications3dMapper contraindications3dMapper) {
