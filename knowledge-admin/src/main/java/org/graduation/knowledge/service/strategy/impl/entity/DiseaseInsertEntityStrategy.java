 ...
 * @author huyuanxin
 */
@Service("DiseaseInsertEntityStrategy")
public class DiseaseInsertEntityStrategy implements InsertEntityStrategy {

    final private Symptom3dMapper symptom3dMapper;
    final private Disease3dMapper disease3dMapper;

    @Autowired
    public DiseaseInsertEntityStrategy(Symptom3dMapper symptom3dMapper, Disease3dMapper disease3dMapper) {
