 ...
 * @author huyuanxin
 */
@Service("DiagnosisInsertStrategy")
public class DiagnosisInsertStrategy implements InsertStrategy {

    final private Treatment3dMapper treatment3dMapper;
    final private Diagnosis3dMapper diagnosis3dMapper;

    @Autowired
    public DiagnosisInsertStrategy(Treatment3dMapper treatment3dMapper, Diagnosis3dMapper diagnosis3dMapper) {
