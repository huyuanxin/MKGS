 ...
 * @author huyuanxin
 */
@Service("HighRiskFactorsInsertEntityStrategy")
public class HighRiskFactorsInsertEntityStrategy implements InsertEntityStrategy {
    ...
    @Autowired
    public HighRiskFactorsInsertEntityStrategy(PrognosticSurvivalTime3dMapper prognosticSurvivalTime3dMapper, HighRiskFactors3dMapper highRiskFactors3dMapper) {
