 ...
 * @author huyuanxin
 */
@Service("PathophysiologyInsertEntityStrategy")
public class PathophysiologyInsertEntityStrategy implements InsertEntityStrategy {
    ...
    @Autowired
    public PathophysiologyInsertEntityStrategy(Symptom3dMapper symptom3dMapper, Disease3dMapper disease3dMapper, Pathophysiology3dMapper pathophysiology3dMapper) {
