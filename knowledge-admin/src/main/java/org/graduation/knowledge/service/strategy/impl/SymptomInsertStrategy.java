 ...
 * @author huyuanxin
 */
@Service("SymptomInsertStrategy")
public class SymptomInsertStrategy implements InsertStrategy {

    final private Symptom3dMapper symptom3dMapper;
    final private Disease3dMapper disease3dMapper;

    @Autowired
    public SymptomInsertStrategy(Symptom3dMapper symptom3dMapper, Disease3dMapper disease3dMapper) {
